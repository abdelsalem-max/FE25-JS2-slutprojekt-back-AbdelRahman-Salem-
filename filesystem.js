...
exports.removeWork = exports.addMembers = exports.readMembers = exports.moveList = exports.assignMemberToWork = exports.addList = exports.readList = void 0;
...
const assignMemberToWork = async (id, memberName) => {
    const works = await (0, exports.readList)();
    const work = works.find((item) => item.id === id);
    if (!work) {
        return undefined;
    }
    work.assignedto = memberName;
    await promises_1.default.writeFile(PATH_work, JSON.stringify(works, null, 2));
    return work;
};
exports.assignMemberToWork = assignMemberToWork;
